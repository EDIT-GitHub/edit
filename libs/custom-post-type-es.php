...
function register_cpt_profissoes() {
    ...
    $labels = array( 
        'name' => _x( 'Profesiones', 'profissoes' ),
        'singular_name' => _x( 'Profesión', 'profissoes' ),
        'add_new' => _x( 'Adicionar Profesión', 'profissoes' ),
        'add_new_item' => _x( 'Adicionar Profesión', 'profissoes' ),
        'edit_item' => _x( 'Editar Profesión', 'profissoes' ),
        'new_item' => _x( 'Nova Profesión', 'profissoes' ),
        'view_item' => _x( 'Ver Profesión', 'profissoes' ),
        'search_items' => _x( 'Procurar Profesión', 'profissoes' ),
        'not_found' => _x( 'Nenhum Profesión encontrado', 'profissoes' ),
        'not_found_in_trash' => _x( 'Nenhum Profesión encontrado no lixo', 'profissoes' ),
        'parent_item_colon' => _x( 'Profesión Pai:', 'profissoes' ),
        'menu_name' => _x( 'Profesiones', 'profissoes' ),
    );
    ...
    $args = array( 
        ...
        'menu_position' => 20,
        'hierarchical' => true,
        'rewrite' => array( 'slug' => 'profesiones' ),
        'show_in_nav_menus' => true,
        'publicly_queryable' => true,
        'exclude_from_search' => false,
        'has_archive' => false,
...
function register_cpt_projectos360() {
    ...
    $args = array(
        ...
        'menu_position' => 20,
        'hierarchical' => true,
        'rewrite' => array( 'slug' => 'proyecto-360' ),
        'show_in_nav_menus' => true,
        'publicly_queryable' => true,
        'exclude_from_search' => false,
        'has_archive' => false,
...
function register_cpt_recrutamento() {
    ...
    $args = array(
        ...
        'hierarchical' => true,
        'show_in_nav_menus' => true,
        'rewrite' => array( 'slug' => 'busqueda-de-talento' ),
        'publicly_queryable' => true,
        'exclude_from_search' => false,
        'has_archive' => false,
        'query_var' => true,
