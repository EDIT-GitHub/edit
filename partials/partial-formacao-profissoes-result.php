<?php
/**
 * Template Name: Formacao Profissões Results
 * The template for Formacao Profissões Results
 *
 * @package Edit
 */
$firstTime = true;
...
$itemNumber = '';
$special = '';
$area_de_formacao = get_sub_field('tipo_de_formacao');
...
$meta_query = array('relation' => 'AND',
   array(
    'key' => 'area_formacao', 
    //'value' => '1246', id area de formação
    'value' => $area_de_formacao,
    'compare' => 'LIKE'
),
   array(
    'key'           => 'home_data',
