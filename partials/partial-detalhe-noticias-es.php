<?php
/**
 * The template for Detalhe Noticias ES
 *
 * @package Edit
 */
?>
        ...
        <div class="grid-cont">
            ...
            <div class="square">
                ...
                <div class="icon-cont">
                    ...
                    <span class="icon-label">Noticia</span>
                </div>
            </div>
        </div>
    </div>
...
<div class="content">
   	<div class="block-news-details">
          ...
          <div class="content-grid">
                        ...
                        case 'links':
                           ...
                           <div class="interview-links">
                            ...
                            ?>
                                ...
                                <a class="default-btn interview" href="<?php the_sub_field('link'); ?>" target="_blank" class="no-route">
                                    <div class="btn-icon">
                                        <div class="inner">
                            
                                        </div>
                                    </div>
                                    <span class="label"><?php the_sub_field('titulo'); ?></span>
                                </a>
            ...
            <?php /*
            <h3>
                Em termos práticos o serviço de branding é destinado a novos
                empresários e negócios ou a Brand Managers de empresas que 
                necessitem de criar uma nova marca de consumo ou re-estruturar uma 
                marca já no mercado
             </h3>
            <p>Parte, portanto, de um estudo do espaço onde a marca se quer afirmar no mercado e da consequente criação de atributos na marca para que esta se envolva de forma emotiva com a audiência escolhida. Um dos fatores que mais atrai o consumidor é a garantia de qualidade que está por detrás da marca ou da sua própria origem e valores. Todos estes atributos devem fazer parte da mensagem de uma marca, mesmo que esteja em processo de criação.

      Em termos práticos o serviço de branding é destinado a novos empresários e novos negócios ou a Brand Managers de empresas que necessitem de criar uma nova marca de consumo ou re-estruturar uma marca já no mercado (neste último caso dá-se o nome de RE-BRANDING).

      A EDIT que, orgulhosamente esteve no processo da criação e re-estruturação de algumas marcas, oferece um serviço completo aos seus clientes que desejem constuir uma nova marca, dando-lhes também garantias, dada a experiência que já tem na construção de outras marcas, de um trabalho de continuidade, quer a nível conceptual, quer a nível de meios (desde logotipos, à construção de websites).</p>
            <blockquote class="margin-50">
                <img src="<?php bloginfo('template_url');?>/images/assets/svg/quotes-square.svg" />
                <p>O processo criativo de 
                criação de uma marca...</p>
            </blockquote>
            <!--<h1>O processo criativo de 
            criação de uma marca...</h1>-->
            <img src="<?php bloginfo('template_url');?>/images/dummy/noticias/new1.jpg"/> 
            <p>
              Texto descritivo relacionado com o vídeo acima exposto. Fase de pré-produção, onde se define um nome para a marca, um claim/slogan, um símbolo, uma linha gráfica, entre outras componentes.
            </p>
            <img src="<?php bloginfo('template_url');?>/images/dummy/noticias/new1.jpg"/>
            <p>
              Texto descritivo relacionado com o vídeo acima exposto. Fase de pré-produção, onde se define um nome para a marca, um claim/slogan, um símbolo, uma linha gráfica, entre outras componentes.
            ...
            <p class="no-margin-top">
              A metodologia de trabalho na construção de uma marca segue as seguintes orientações:
              <br><br>
              <b>Estudo concetual: </b><br>
              os valores inerentes à motivação do cliente - é normal, sempre que tenhamos um briefing novo para a criação de uma nova marca, o cliente ter algumas ideias do que a marca deve transmitir, que são normalmente valores de origem pessoal ou pré-conceitos oriundos de outras marcas concorrentes ou estrangeiras que são referência para o nosso cliente.
              <br><br>
              <b>Estudo visual: </b><br>
              é também comum, o cliente ter uma ideia visual de como quer que o logotipo da marca seja, o que deve dizer o naming, qual a cor que deve inspirar a comunicação da marca, ou mesmo o claim que deve estar associado ao logotipo. Neste processo, tal como no anterior, a BYDAS tentará sempre o equilibrio 50/50 com o cliente, assessorando-o no sentido de garantirmos que todas as ideias trazidas pelo nosso cliente podem ser postas em prática sem violarem todos os processos metodologicos que envolvem a criação da marca.
              <br><br>
              <b>Estratégia: </b><br>
              este é o momento chave para a construção da marca. Nesta fase é imperativo encontrar um mercado e um posicionamento para a marca. Todas as conclusões retiradas deste processo terão um efeito prático muito relevante nos materiais de comunicação que se construam mais tarde.
              <br><br>
              <b>Criação: </b><br>
              esta é uma fase de pré-produção, onde se define um nome para a marca, um claim/slogan, um símbolo, uma linha gráfica, entre outras componentes visuais. Esta fase termina com o desenvolvimento de um manual de normas de marca onde ficarão espelhadas as regras de utilização de suportes visuais, do naming e do claim da marca;
              <br><br>
              <b>Desenvolvimento de suportes gráficos: </b><br>
              Estando a fase de criação concluída, normalmente o cliente requer também a criação de suportes gráficos para a comunicação da marca, como cartões de visitas, suportes de papelaris (envelopes, papel de carta, etc...), catálogo de produtos, website, ativação de perfis sociais, etc...              
            </p>
            <div class="video-block margin-top-100">
            ...
            <p>Texto descritivo relacionado com o vídeo acima exposto. Fase de pré-produção, onde se define um nome para a marca, um claim/slogan, um símbolo, uma linha gráfica, entre outras componentes.</p>  
                   */ ?>
          </div>
   		</div>
   	</div>
    ...
    <div class="block-news-details yellow">
		  <div class="bg"></div>
		<?php /* 
<div class="grid-cont border-bottom">
      <div class="content-grid">
  			<div class="content-header">
  				<img src="<?php bloginfo('template_url');?>/images/dummy/noticias/tv.png"/>
  				<div>
  					<h1>DIGITAL</h1>
  					<h1>VISUAL DESIGN</h1>
  					<P class="black">SABE MAIS SOBRE DIGITAL VISUAL DESIGN NA EDIT DA TUA ÁREA</P>					
  				</div>
  			</div>
        <div class="locations">
          <div class="location"><a href="">EDIT LISBOA</a></div>
          <div class="location"><a href="">EDIT PORTO</a></div>
        </div>
      </div>
    </div>
           * */?>
