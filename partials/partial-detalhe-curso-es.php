<?php
/**
 * The template for Curso Espanha
 *
 * @package Edit
 */
...
<div class="content">
  ...
  <div class="slider form flex full curso <?php echo $cssClassType; ?>  js-formmodal">
    ...
    <div class="form-content">
      <div class="btn">
        <?php 
        if(get_field('link_formulario')): 
          $url = get_field('link_formulario'); ?>
      ...
      <div class="slider-item">
        <div class="grid-cont">
          <div class="content v-align">
           ...
           <input id="nome" name="name" type="text" data-type="text" placeholder="NOMBRE" />
            ...
            <div class="filter">
              ...
              <select id="assunto" data-exterior-label="Curso" name="assunto">
                <?php if ($formClass == 'workshop') { ?>
                 <option value="Informacao-workshops">PEDIDO DE INFORMACIÓN</option>
                 <option value="Inscricao">REGISTRO</option>
               <?php } else { ?>
                <option value="SOPP" selected>AGENDAR SOPP</option>
                <option value="Informacao">PEDIDO DE INFORMACIÓN</option>
              <?php } ?>
            </select>
          </div>
        </div>

        <input id="telefone" name="telefone" maxlength="14" data-type="phone" type="text" placeholder="+34 000 000 000" />
        <input id="pais" name="pais" data-type="text" type="text" placeholder="PAÍS" />
        <input id="cidade" name="cidade" data-type="text" type="text" placeholder="CIUDAD" />
        <textarea name="message" id="message" placeholder=Mensaje></textarea>
        <div class="content-radio interests">
          <label class="area-label">Intereses</label>
          <div class="checkbox">
            <div class="radio">
        ...
        <div class="default-btn btn-gdpr">
          ...
          <span class="label-text label">Este sitio utiliza cookies. Al someter este formulario estará consentido su uso.
            <br>
            <a class="label-href" href="/politica-de-privacidad/" class="no-route" target="_blank">Política de Privacidad</a>
          </span>
        </div>
      </div>
    </div>
...
<script>
  ...
  jQuery(document).ready(function ($) {
    ...
    Edit.modules.collection.push({ type: 'formModal', instance: new Edit.modules.formModal('.js-formmodal', 'registration_form','<?php echo $type; ?>',"<?php the_title(); ?>") });
  })
</script>
    ...
    <div class="date">
      ...
      if(have_rows('horario_semanal')):
        ...
        function getHour($day){
                            ...
                            <div class="day curso <?php echo $cssClassType; ?>">
                              ...
                              <div>
                               <!--AQUI-->   <div>
                                ...
                                <?php }else if($day == "M"){?>
                                  <div class="sab">M</div>
                                  <div class="small-txt">AR</div>
                                <?php }else if($day == "Mi"){?>
                                  <div class="sab">M</div>
                                  <div class="small-txt">IE</div>
                                <?php }else if($day == "J"){?>
                                  <div class="sab">J</div>
          ...
          <div class="block-formacao-info form-content curso <?php echo $cssClassType; ?> margin-100">
            <?php if(get_field('link_formulario')): 
              $url = get_field('link_formulario'); ?>
              <a class="btn link" href="<?php echo $url; ?>" target="_blank"> 
                <?php the_field('titulo_formulario')?>  
        ...
        <?php if(get_field('video')): ?>    
          <div class="slider-media" style="text-align:center">
