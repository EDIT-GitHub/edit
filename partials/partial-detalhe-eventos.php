...
<div class="content">
                ...
                <div class="btn-close">
                    <div class="icon-close">
                        <svg version="1.0" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <path fill="#fff"
                                d="M18.639,13.664l-5.656-5.656c-0.586-0.586-1.536-0.586-2.121,0c-0.586,0.586-0.586,1.536,0,2.121l4.733,4.733l-4.733,4.733
                        ...
                        <svg version="1.0" id="invert" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="30px" height="30px"
                            viewBox="0 0 30 30" enable-background="new 0 0 30 30" xml:space="preserve">
                            <path fill="#fff"
                                d="M18.639,13.664l-5.656-5.656c-0.586-0.586-1.536-0.586-2.121,0c-0.586,0.586-0.586,1.536,0,2.121l4.733,4.733l-4.733,4.733
                        ...
                        <div class="grid-cont">
                            <div class="content v-align">
                                <input id="evento" name="evento" type="hidden"
                                    value="<?php echo htmlspecialchars(get_field('titulo')); ?>" />
                                <input id="nome" name="name" type="text" data-type="text"
                                    placeholder="<?php dictionary('NOME') ?>" />
                                <input id="email" name="email" type="text" data-type="email" placeholder="EMAIL" />
                                <input id="telefone" name="telefone" data-type="phone" type="text"
                                    placeholder="<?php dictionary('PHONE_PLUS') ?>" />
                                <?php 
                                if (get_the_ID() == '35535' || get_the_ID() == '35573'): ?>
                                <div class="content-radio interests">
                                    <label class="area-label"><?php dictionary('Sessao_a_frequentar') ?></label>
                                    <div class="checkbox">
                                        <div class="radio">
                                            <input type="radio" name="radio" id="interest-1" value="Digital Design"
                                                required>
                                            <label class="interests" for="interest-1"></label>
                                            Digital Design
                                        </div>
                                        <div class="radio">
                                            <input type="radio" name="radio" id="interest-2" value="Front-end" required>
                                ...
                                <?php endif; ?>
                                <?php 
                                if (get_the_ID() == '35525' || get_the_ID() == '35505'): ?>
                                <div class="content-radio interests">
                                    <label class="area-label"><?php dictionary('Sessao_a_frequentar') ?></label>
                                    <div class="checkbox">
                                        <div class="radio">
                                            <input type="radio" name="radio" id="interest-1" value="Digital Marketing"
                                                required>
                                            <label class="interests" for="interest-1"></label>
                                            Digital Marketing
                                        </div>
                                        <div class="radio">
                                            <input type="radio" name="radio" id="interest-2" value="UX" required>
                                            <label class="interests" for="interest-2"></label>
                                            UX
                                        </div>
                                    </div>
                                ...
                                <textarea name="message" id="message"
                                    placeholder="<?php dictionary('Mensagem') ?>"></textarea>
                                ...
                                <div class="default-btn btn-gdpr">
                                    <div class="checkbox">
                                        <input id="gdpr" class="gdpr-input" type="checkbox" name="checkbox"
                                            checked="checked">
                                        <label class="label-gdpr" for="gdpr">
                                            <span class="icon-check"></span>
                                        </label>
                                    </div>
                                    <span class="label-text label">Este site utiliza cookies. Ao submeter este
                                        formulário estará a consentir a sua utilização.
                                        <br>
                                        <a class="label-href" href="/politica-de-privacidade/" class="no-route"
    ...
    jQuery(document).ready(function($) {
        Edit.modules.collection.push({
            type: 'formModal',
            instance: new Edit.modules.formModal('.js-formmodal', 'eventos_form', 'eventos')
        });
    })
    </script>
    ...
    <div class="header js-header flex full">
        <div class="header-item entrevista">
            ...
            <div class="background <?php echo $responsiveClass; ?>">
                <div class="img" draggable="false" style="background-image:url(<?php the_field('fundo_header');?>)">
                </div>
                <div class="img-overlay"></div>
                <?php if(get_field('fundo_header_responsive') != ''){ ?>
                <div class="img-smartphone" draggable="false"
                    style="background-image:url(<?php the_field('fundo_header_responsive');?>)"></div>
                <?php } ?>
                <div class="pixels"
                    style="background-image:url(<?php bloginfo('template_url');?>/images/dummy/formacao/header/pixel.png)">
                </div>
            </div>
                ...
                <div class="header-description">
                    <div class="square">
                        <svg version="1.1" id="Camada_1" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <polygon fill="#FFFFFF"
                                points="53.9,276 4,276 4,4 276,4 276,49.2 280,49.2 280,0 0,0 0,280 53.9,280 " />
                        </svg>
        ...
        jQuery(document).ready(function($) {
            Edit.modules.collection.push({
                type: 'header',
                instance: new Edit.modules.smallHeader('.js-header')
            })
        })
        </script>
    ...
    <div class="js-availability block-availability" data-total="20" data-registered="12">
        <div class="grid-cont">
            <div class="date">
                <div class="bg">
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="110px" height="110px"
                        viewBox="0 0 110 110" enable-background="new 0 0 110 110" xml:space="preserve">
                        <path fill="#FFDF00"
                            d="M108.5,0c0,2-1.791,4-4,4s-4-2-4-4h-1c0,2-1.791,4-4,4s-4-2-4-4h-1c0,2-1.791,4-4,4s-4-2-4-4h-1
            ...
            <div class="graph-info">
                ...
                ?>
                        <span>(
                            <?php echo $total;?> vagas disponíveis)</span>
                    </div>
                    <div class="total">
                        <p><span class="registered">
                                <?php echo get_field('vagas_ocupadas'); ?></span>/
                            <?php echo get_field('vagas_totais'); ?>
                        </p>
                    </div>
                </div>
                <div class="graph-row">
...
?>
    ...
    <div class="video-block margin-50">
        <iframe src="<?php the_sub_field('url_video'); ?>" "width=" 720" height="405" frameborder="0"
        ...
        <div class="grid-cont">
            <div class="content-valign">
                <div class="share-content">
                    <a href="javascript:Edit.modules.windowpop('https://twitter.com/share?url=<?php the_permalink() ?>',600,400);"
                        target="">
                        <div class="icon twitter">
                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="60" height="60"
                                viewBox="-3.5 -3.5 60 60" enable-background="new 0 0 60 60" xml:space="preserve">
                                <path fill="#cccccc"
                                    d="M25.5,11.81c-0.629,0.27-1.301,0.46-2,0.54c0.721-0.42,1.27-1.1,1.529-1.9c-0.67,0.4-1.42,0.68-2.219,0.83
                    ...
                    <a href="javascript:Edit.modules.windowpop('https://www.facebook.com/sharer/sharer.php?u=<?php the_permalink() ?>',600,400);"
                        target="">
                        <div class="icon facebook">
                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                ...
                                viewBox="-3.5 -3.5 60 60" enable-background="new 0 0 60 60" xml:space="preserve">
                                <path fill="#cccccc"
                                    d="M12.75,14.12h1.82v-1.71c0-0.75,0.02-1.91,0.59-2.63c0.6-0.76,1.41-1.28,2.82-1.28
                    ...
                    <a href="javascript:Edit.modules.windowpop('https://www.linkedin.com/cws/share?url=<?php the_permalink() ?>',600,400);"
                        target="">
                        <div class="icon in">
                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="60" height="60"
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd" fill="#cccccc"
                                    d="M25.5,24.65h-3.76v-5.38c0-1.41-0.58-2.37-1.881-2.37
                ...
                c0-1.021,0.8-1.801,2.02-1.801c1.23,0,1.98,0.78,2,1.801C12.52,12.16,11.75,12.96,10.5,12.96z M12.24,24.65H8.93V14.26h3.31V24.65z" />
                    ...
                    <a href="javascript:Edit.modules.windowpop('http://pinterest.com/pin/create/link/?url=<?php the_permalink() ?>',600,400);"
                        target="">
                        <div class="icon pinterest">
                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="60" height="60"
                                viewBox="-4.5 -4.5 60 60" enable-background="new 0 0 60 60" xml:space="preserve">
                                <path fill="#cccccc"
                                    d="M17,8.5c-4.69,0-8.5,3.8-8.5,8.5c0,3.479,2.09,6.47,5.09,7.78c-0.03-0.59-0.01-1.311,0.15-1.95l1.09-4.63
            ...
            c4.689,0,8.5-3.81,8.5-8.5C25.5,12.3,21.689,8.5,17,8.5z" />
                    ...
                    <a
                        href="javascript:Edit.modules.windowpop('https://plus.google.com/share?url=<?php the_permalink() ?>',600,400);">
                        <div class="icon g_plus">
                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="60" height="60"
                                viewBox="2 2 60 60" enable-background="new 0 0 60 60" xml:space="preserve">
                                <g>
                                    <path fill="#FFFFFF"
                                        d="M12.922,20.576c-1.471,0-2.534-0.931-2.534-2.05c0-1.097,1.318-2.009,2.79-1.993
...
jQuery(document).ready(function($) {
    ...
    Edit.modules.collection.push({
        ...
        instance: new Edit.modules.innerNavigation('<?php echo $links["next"];?>',
            '<?php echo $links["prev"]; ?>', '<?php echo $parent_url; ?>')
    })
