...
if($dataInicio != false){
  ...
  if($hoje > $dataInicio){
    //Colocar data a definir quando ultrapassa o dia atual
    $end = true;
  }
} 
      ...
      <div class="slider-item">
        <div class="grid-cont">
          <div class="content v-align">
            ...
            <input id="nome" name="name" type="text" data-type="text" placeholder="NAME" autofocus />
            ...
            <div class="filters-holder">
              <div class="filter">
                ...
                <select id="assunto" data-exterior-label="Curso" name="assunto">
                  ...
                  <option value="Informacao">Information request</option>
                  <?php if ($formClass == 'int-workshop'): ?>
                    <option value="Inscricao">Registration</option>
                    <?php else: ?>
                      <option value="SOPP" selected>SOPP request</option>
                    <?php endif; ?>
                  </select>
                </div>
              </div>
              ...
              <input id="pais" name="pais" data-type="text" type="text" placeholder="COUNTRY" />
              <input id="cidade" name="cidade" data-type="text" type="text" placeholder="CITY" />
              <textarea name="message" id="message" placeholder="Message"></textarea>
              <div class="content-radio interests">
               <label class="area-label">Interests</label>
               <div class="checkbox">
                 <div class="radio">
             ...
             <div class="default-btn btn-gdpr">
              ...
              <span class="label-text label">This site uses cookies. By submitting this form you will consent to its use.
                <br>
                <a class="label-href" href="<?php echo dictionary("gdpr_href"); ?>" class="no-route" target="_blank">Privacy Policy</a>
              </span>
            </div>
          </div>
        </div>
...
<script>
  ...
  var inscricao = "Registration";
  var success = "Success";
  var sending = "Sending";
  var form_sucesso = "Request sent <br />successfully";
  ...
  jQuery(document).ready(function ($) {
    ...
    Edit.modules.collection.push({ type: 'formModal', instance: new Edit.modules.formModal('.js-formmodal', 'workshop_form_en','<?php echo $type; ?>',"<?php the_title(); ?>") });
  })
</script>
    ...
    if (have_rows('bloco_infomacao')):
      while (have_rows('bloco_infomacao')):
        ...
        switch ($tipo)
        {
          ...
          case 'icon-idioma': ?>
          <div class="block-info">
            <div class="icon icon-idioma"></div>
            <div class="info">
              <p><?php the_sub_field('info_titulo') ?></p>
              <span><?php the_sub_field('info_descricao') ?></span>
            </div>
