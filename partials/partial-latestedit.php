...
<div class="grid-cont">
    <div class="filter">
        <select id="inputTipo" data-exterior-label="<?php _e('Tipo', 'edit'); ?>" name="inputTipo">
         ...
         <option value="blog" <?php if($inputTipoId == "blog"): ?>selected<?php endif; ?>><?php _e('Blog', 'edit'); ?></option>
         <option value="noticias" <?php if($inputTipoId == "noticias"): ?>selected<?php endif; ?>><?php _e('Noticias', 'edit'); ?></option>
 ...
 <script>
    jQuery(document).ready(function( $ ) {
        Edit.modules.collection.push({ type: 'filters', instance: new Edit.modules.filtersModule('.js-filters', '/results/latestedit-results') })
    })
</script>
</div>
...
<div class="filtered-content">
    <div class="js-iso-module filtered margin-50 js-cursos">
        <div class="grid-cont">
            ...
            <?php get_template_part( 'partials/partial', 'latestedit-response' ); ?>
        </div>
        <script>
            jQuery(document).ready(function( $ ) {
...
<script>
    jQuery(document).ready(function( $ ) {
        Edit.modules.collection.push({ type: 'loadMore', instance: new Edit.modules.loadMore('.js-loadmore', true, '/results/latestedit-results/')});
    })
</script>
</div>
