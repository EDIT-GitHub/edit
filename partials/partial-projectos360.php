<?php
/**
 * The template for Projectos 360
 *
 * @package Edit
 */
                    ...
                    <div class="grid-cont">
                        ...
                        <div class="summary" style="width: 91%;">
                            ...
                            <div class="slider-description" style="margin-top: 18px;">                                   
                                <p class="subtitulo"><?php dictionary("O_contacto_com_as_marcas") ?></p>
                            </div>
                        </div>
                        <div class="icon-cont">
...
<div class="grid-cont">
    ...
    <div class="filter">
        <select id="inputCliente" data-exterior-label="<?php _e('Cliente', 'edit'); ?>" name="inputCliente">
           <option value="0" <?php if($inputClienteId == "0"): ?>selected<?php endif; ?>>Todos</option>
           <?php
           ...
           $clientes = get_posts( $arguments );

           foreach($clientes as $cliente):
            ?>
            <option value="<?php echo $cliente->ID ?>" <?php if($inputClienteId == $cliente->ID): ?>selected<?php endif; ?>><?php echo $cliente->post_title; ?></option>
            <?php                                                                                                                                      
        endforeach;
        ?>
...
<script>
    jQuery(document).ready(function( $ ) {
        Edit.modules.collection.push({ type: 'filters', instance: new Edit.modules.filtersModule('.js-filters', '/results/projectos-360/') })
    })
</script>
</div>
...
<div class="filtered-content">
    <div class="js-iso-module filtered margin-50 js-cursos">
        <div class="grid-cont">
            ...
            <?php get_template_part( 'partials/partial', 'projectos360-response' ); ?>
        </div>
        <script>
            jQuery(document).ready(function( $ ) {
