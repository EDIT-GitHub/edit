...
<div class="grid-cont">
    ...
    <script>
        jQuery(document).ready(function( $ ) {
            Edit.modules.collection.push({ type: 'filters', instance: new Edit.modules.filtersModule('.js-filters', '/results/noticias-results/') })
        })
    </script>
</div>
...
<div class="filtered-content">
    <div class="js-iso-module filtered margin-50 js-cursos">
        <div class="grid-cont">
            ...
            <?php get_template_part( 'partials/partial', 'noticias-response' ); ?>
        </div>
        <script>
            jQuery(document).ready(function( $ ) {
...
<script>
    jQuery(document).ready(function( $ ) {
        Edit.modules.collection.push({ type: 'loadMore', instance: new Edit.modules.loadMore('.js-loadmore', true, '/results/noticias-results/') });
    })
</script>
</div>
