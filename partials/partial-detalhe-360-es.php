...
?>
<link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/dist/css/p360.min.css" />
<link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/bootstrap.css" />
<script src="<?php bloginfo('template_url'); ?>/scripts/jssor.slider-24.1.2.min.js"></script>
        ...
        if (have_rows('tipos_de_bloco')):
          while (have_rows('tipos_de_bloco')):
            ...
            switch ($template) {
              ...
              case 'imagem_largura':
              ?>
              <div class="col-xs-12 p360div nopaddingbootstrap text-center">
                <img src="<?php
              ...
              <div class="slider1_container">
                <div id="jssor_1" style="position:relative; width:1000px;height:563px; visibility:hidden; margin-bottom: 40px; ">
                  <div class="overlayLeft"></div>
                  <div class="overlayRight"></div>
                  <div data-u="slides" style="position:relative; width:100%;height:450px;">
                    <?php
                    if (have_rows('slides')):
