...
<div class="content">
                        ...
                        <div class="header-description">
                            <div class="square">
                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    x="0px" y="0px" width="70px" height="70px" viewBox="0 0 70 70" enable-background="new 0 0 70 70"
                                    xml:space="preserve">
                                    <polygon fill="#FFFFFF" points="67,60 67,67 3,67 3,3 67,3 67,10 70,10 70,0 0,0 0,70 70,70 70,60 " />
                                </svg>
                            </div>
                            <div class="summary">
                                <h1>DISRUPTIVE BLOG</h1>
                            </div>
                            <div class="icon-cont">
                            </div>
                        </div>
    ...
    <div class="filtered-content">
        <div class="blog-module filtered js-cursos">
            <div class="grid-cont">
                <div class="block-full detail blog" data-old="block-full">
                    <div class="block-content">
                        <div class="inner">
                            <div class="sticky p-sticky disable-md">
                                <div class="block-description">
                                    <div class="event-details">
                                        <div class="square">
                                            ...
                                            <p class="day">AD</p>
                                            <p class="month">
                                                <?php echo strtoupper(dictionary("Data_a_definir"));?>
                                            </p>
                                            <?php endif;?>
                                        </div>
                                        <div class="icon-cont">
                                            ...
                                            <div class="vote vote--position hide-md">
            ...
            <div class="grid-cont">
                <div class="separator-gray  margin-50">
            ...
            <script>
                ...
                */
                (function() { // DON'T EDIT BELOW THIS LINE
                    ...
                    s.src = 'https://site-edit.disqus.com/embed.js';
            ...
            <script>
                ...
                */
                (function() { // DON'T EDIT BELOW THIS LINE
                    var d = document,
                        s = d.createElement('script');
                    s.src = 'https://edit-com-es.disqus.com/embed.js';
                    s.setAttribute('data-timestamp', +new Date());
                    (d.head || d.body).appendChild(s);
                })();
            </script>
    ...
    ?>
        <div class="shareLightbox">
            <div class="btn-close">
                ...
                <div class="icon-close">
                    ...
                    <svg version="1.0" id="invert" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        x="0px" y="0px" width="30px" height="30px" viewBox="0 0 30 30" enable-background="new 0 0 30 30"
                        xml:space="preserve">
                        <path fill="#fff" d="M18.639,13.664l-5.656-5.656c-0.586-0.586-1.536-0.586-2.121,0c-0.586,0.586-0.586,1.536,0,2.121l4.733,4.733l-4.733,4.733
                c-0.586,0.586-0.586,1.535,0,2.121c0.293,0.293,0.677,0.439,1.061,0.439s0.768-0.146,1.061-0.439l5.656-5.656
                    ...
                    <div class="share-content">
                        <a href="javascript:Edit.modules.windowpop('https://twitter.com/share?url=<?php the_permalink() ?>',600,400);"
                            ...
                            <div class="icon twitter">
                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    x="0px" y="0px" width="60" height="60" viewBox="-3.5 -3.5 60 60" enable-background="new 0 0 60 60"
                                    xml:space="preserve">
            ...
            c0-1.021,0.8-1.801,2.02-1.801c1.23,0,1.98,0.78,2,1.801C12.52,12.16,11.75,12.96,10.5,12.96z M12.24,24.65H8.93V14.26h3.31V24.65z" />
                        ...
                        <a href="javascript:Edit.modules.windowpop('http://pinterest.com/pin/create/link/?url=<?php the_permalink() ?>',600,400);"
                            ...
                            <div class="icon pinterest">
                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    x="0px" y="0px" width="60" height="60" viewBox="-4.5 -4.5 60 60" enable-background="new 0 0 60 60"
                                    xml:space="preserve">
        ...
        c4.689,0,8.5-3.81,8.5-8.5C25.5,12.3,21.689,8.5,17,8.5z" />
                        ...
                        <a href="javascript:Edit.modules.windowpop('https://plus.google.com/share?url=<?php the_permalink() ?>',600,400);">
                            <div class="icon g_plus">
                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    x="0px" y="0px" width="60" height="60" viewBox="2 2 60 60" enable-background="new 0 0 60 60"
                                    xml:space="preserve">
                                    <g>
        ...
        <?php if (! is_user_logged_in() && LANGUAGE == 'PT' ): ?>
        <script type="text/javascript" src="https://site-edit.disqus.com/count.js" async></script>
        <?php else: ?>
        <script type="text/javascript" src="https://edit-com-es.disqus.com/count.js" async></script>
        <?php endif; ?>
        <script>
